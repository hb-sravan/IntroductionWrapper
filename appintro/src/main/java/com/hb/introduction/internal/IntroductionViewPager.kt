package com.hb.introduction.internal
...
import com.hb.introduction.IntroductionBaseActivity
import com.hb.introduction.IntroductionPageTransformerType
import com.hb.introduction.IntroductionViewPagerListener
import com.hb.introduction.internal.viewpager.ViewPagerTransformer
import kotlin.math.absoluteValue
import kotlin.math.max

/**
 * Class that controls the [IntroductionBaseActivity] of IntroductionBaseActivity.
 ...
 */
internal class IntroductionViewPager(context: Context, attrs: AttributeSet) : ViewPager(context, attrs) {

    var isFullPagingEnabled = true
    var isPermissionSlide = false
    var lockPage = 0
    var onNextPageRequestedListener: IntroductionViewPagerListener? = null
    ...
    internal fun addOnPageChangeListener(listener: IntroductionBaseActivity.OnPageChangeListener) {
    ...
    fun setAppIntroPageTransformer(introductionTransformer: IntroductionPageTransformerType) {
        setPageTransformer(true, ViewPagerTransformer(introductionTransformer))
    }
