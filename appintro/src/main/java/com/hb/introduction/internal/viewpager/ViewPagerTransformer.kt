package com.hb.introduction.internal.viewpager
...
internal class ViewPagerTransformer(
    private val transformType: IntroductionPageTransformerType
    ...
    override fun transformPage(page: View, position: Float) {
        when (transformType) {
            IntroductionPageTransformerType.Flow -> {
                page.rotationY = position * FLOW_ROTATION_ANGLE
            }
            IntroductionPageTransformerType.SlideOver -> transformSlideOver(position, page)
            IntroductionPageTransformerType.Depth -> transformDepth(position, page)
            IntroductionPageTransformerType.Zoom -> transformZoom(position, page)
            IntroductionPageTransformerType.Fade -> transformFade(position, page)
            is IntroductionPageTransformerType.Parallax -> {
